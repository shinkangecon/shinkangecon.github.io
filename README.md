...
<details>
 ...
 <a href="https://drive.google.com/file/d/1hI1sSDKdnUsiuc8zA3zebvz3PgSCEYJy/view?usp=sharing" target="_blank"><u>[Paper (PDF)]</u></a>
...
<details>
 ...
 <details>
  ...
  | **Summary**          |
  |:---------------------------|
  | East Asians, especially South Koreans, are apparently preoccupied with their children’s education – most children spend time in expensive private institutes and cram schools in the evening and during weekends. At the same time, South Korea currently has the lowest total fertility rate in the world. In this paper we propose a theory with status externality and endogenous fertility that connect these two facts. Using a quantitative heterogeneous-agent model calibrated to Korean micro data, we first find that fertility would be 16% higher in the absence of the status externality. We then explore how government interventions affect fertility and welfare. We find the optimal policy mix of private education taxes and pro-natal transfers that could increase welfare by addressing distortions induced by the status externality. |
